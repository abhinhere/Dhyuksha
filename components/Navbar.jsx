...
export const Navbar = () => {
    return (
        <div>
            <nav className='hidden font-cakra w-screen text-[#F79A07] absolute right-0 lg:flex px-16 pt-5'>
...
const Mobile = () => {
    return (
        <nav className='lg:hidden font-cakra w-screen text-amber-500 absolute right-0 flex pt-5 pl-5'>
