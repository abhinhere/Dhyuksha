...
export const About = () => {
    return (
        <div className='flex flex-col items-center justify-center min-h-screen md:h-screen bg-cover bg-center relative px-4 py-8 md:py-0 bg-[url("leaderbg.png")] bg-opacity-60 bg-black'>
            {/* Overlay gradient */}
