...
const Footer = () => {
    return (
        <footer className="bg-[#1F0201] text-[#F79A07] ">
            <div className="flex flex-col gap-5 items-center justify-center h-[250px]">
                <div className="flex items-center gap-4 pt-">
                    <Image src={img} alt="Jwaala'24" width={50} height={50} />
                    <p className="text-5xl font-makalo">JWAALA'24</p>
                </div>
                <div className="flex items-center font-cakra flex-col">
                    <p>Students Union</p>
                ...
                <a
                    href="https://www.instagram.com/jwaala_cev"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F79A07] flex hover:text-black transition-colors duration-300"
                >
                    <svg
